...
var ActionArea = function (_Component) {
  ...
  _createClass(ActionArea, [{
    ...
    value: function render() {
      var style = Object.assign({}, _actionArea2.default.style, this.props.style);
      if (this.state.isHovered) {
        style = Object.assign({}, style, _actionArea2.default.hoverStyle, this.props.hoverStyle);
      }

      if (this.state.isActive) {
        style = Object.assign({}, style, _actionArea2.default.activeStyle, this.props.activeStyle);
      }
