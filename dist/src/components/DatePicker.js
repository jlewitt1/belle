...
function updatePseudoClassStyle(pseudoStyleIds, properties, preventFocusStyleForTouchAndClick) {
  var styles = [{
    ...
    style: Object.assign({}, _datePicker2.default.hoverPrevMonthNavStyle, properties.hoverPrevMonthNavStyle),
    pseudoClass: 'hover'

  }, {
    id: pseudoStyleIds.nextMonthNavStyleId,
    style: Object.assign({}, _datePicker2.default.hoverNextMonthNavStyle, properties.hoverNextMonthNavStyle),
    pseudoClass: 'hover'
  }];
  ...
  if (preventFocusStyleForTouchAndClick) {
    ...
    focusStyle = Object.assign({}, _datePicker2.default.focusStyle, properties.focusStyle);
  }
...
var DatePicker = function (_Component) {
  ...
  _createClass(DatePicker, [{
    ...
    value: function _renderPrevMonthNav() {
      var prevMonthNavStyle = Object.assign({}, _datePicker2.default.prevMonthNavStyle, this.props.prevMonthNavStyle);

      var prevMonthNavIconStyle = Object.assign({}, _datePicker2.default.prevMonthNavIconStyle, this.props.prevMonthNavIconStyle);
    ...
    value: function _renderNextMonthNav() {
      var nextMonthNavStyle = Object.assign({}, _datePicker2.default.nextMonthNavStyle, this.props.nextMonthNavStyle);

      var nextMonthNavIconStyle = Object.assign({}, _datePicker2.default.nextMonthNavIconStyle, this.props.nextMonthNavIconStyle);
    ...
    value: function _renderNavBar() {
      var navBarStyle = Object.assign({}, _datePicker2.default.navBarStyle, this.props.navBarStyle);
      var monthLabelStyle = Object.assign({}, _datePicker2.default.monthLabelStyle, this.props.monthLabelStyle);
    ...
    value: function _renderWeekHeader() {
      ...
      var weekHeaderStyle = Object.assign({}, _datePicker2.default.weekHeaderStyle, this.props.weekHeaderStyle);

      var dayLabelStyle = Object.assign({}, _datePicker2.default.dayLabelStyle, this.props.dayLabelStyle);
      if (this.props.disabled) {
        dayLabelStyle = Object.assign({}, dayLabelStyle, _datePicker2.default.disabledDayLabelStyle, this.props.disabledDayLabelStyle);
      }

      var weekendLabelStyle = Object.assign({}, dayLabelStyle, _datePicker2.default.weekendLabelStyle, this.props.weekendLabelStyle);
    ...
    value: function _renderDay(currentDate, index) {
      ...
      var dayStyle = Object.assign({}, _datePicker2.default.dayStyle, this.props.dayStyle);

      if (this.props.readOnly) {
        dayStyle = Object.assign({}, dayStyle, _datePicker2.default.readOnlyDayStyle, this.props.readOnlyDayStyle);
      }

      if (isOtherMonth) {
        dayStyle = Object.assign({}, dayStyle, _datePicker2.default.otherMonthDayStyle, this.props.otherMonthDayStyle);
      }

      if (this.props.disabled || isDisabledDay) {
        dayStyle = Object.assign({}, dayStyle, _datePicker2.default.disabledDayStyle, this.props.disabledDayStyle);
      }

      if (currentDate.getDay() === this.localeData.weekEnd) {
        dayStyle = Object.assign({}, dayStyle, _datePicker2.default.weekendStyle, this.props.weekendStyle);
      }

      if (day === (0, _dateHelpers.today)().getDate() && month === (0, _dateHelpers.today)().getMonth() && year === (0, _dateHelpers.today)().getFullYear()) {
        dayStyle = Object.assign({}, dayStyle, _datePicker2.default.todayStyle, this.props.todayStyle);
      }
      ...
      if (this.state.selectedDate && day === this.state.selectedDate.getDate() && currentDate.getMonth() === this.state.selectedDate.getMonth() && currentDate.getFullYear() === this.state.selectedDate.getFullYear()) {
        dayStyle = Object.assign({}, dayStyle, _datePicker2.default.selectedDayStyle, this.props.selectedDayStyle);
        ariaSelected = true;
      }

      if (this.state.focusedDateKey === dateKey) {
        dayStyle = Object.assign({}, dayStyle, _datePicker2.default.focusDayStyle, this.props.focusDayStyle);
        if (this.props.disabled || isDisabledDay) {
          dayStyle = Object.assign({}, dayStyle, _datePicker2.default.disabledFocusDayStyle, this.props.disabledFocusDayStyle);
        }
      }

      if (!this.props.disabled && !this.props.readOnly && this.state.activeDay === dateKey) {
        dayStyle = Object.assign({}, dayStyle, _datePicker2.default.activeDayStyle, this.props.activeDayStyle);
      }
    ...
    value: function render() {
      ...
      var style = Object.assign({}, _datePicker2.default.style, this.props.style);
      if (this.props.readOnly) {
        style = Object.assign({}, style, _datePicker2.default.readOnlyStyle, this.props.readOnlyStyle);
      }

      if (this.props.disabled) {
        style = Object.assign({}, style, _datePicker2.default.disabledStyle, this.props.disabledStyle);
      }

      if (this.preventFocusStyleForTouchAndClick && this.state.isFocused) {
        style = Object.assign({}, style, _datePicker2.default.focusStyle, this.props.focusStyle);
      }

      if (this.state.isActive) {
        style = Object.assign({}, style, _datePicker2.default.activeStyle, this.props.activeStyle);
      }
