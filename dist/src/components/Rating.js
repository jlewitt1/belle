...
function updatePseudoClassStyle(ratingWrapperStyleId, properties, preventFocusStyleForTouchAndClick) {
  ...
  if (preventFocusStyleForTouchAndClick) {
    ...
    ratingFocusStyle = Object.assign({}, _rating2.default.focusStyle, properties.focusStyle);
  }
...
var Rating = function (_Component) {
  ...
  _createClass(Rating, [{
    ...
    value: function render() {
      ...
      var characterStyle = Object.assign({}, _rating2.default.characterStyle, this.props.characterStyle);

      if (this.state.isActive) {
        characterStyle = Object.assign({}, characterStyle, _rating2.default.activeCharacterStyle, this.props.activeCharacterStyle);
      } else if (this.state.isHover) {
        characterStyle = Object.assign({}, characterStyle, _rating2.default.hoverCharacterStyle, this.props.hoverCharacterStyle);
      }

      var wrapperStyle = Object.assign({}, _rating2.default.style, this.props.style);
      if (this.props.disabled) {
        wrapperStyle = Object.assign({}, wrapperStyle, _rating2.default.disabledStyle, this.props.disabledStyle);
        if (this.state.isHover) {
          wrapperStyle = Object.assign({}, wrapperStyle, _rating2.default.disabledHoverStyle, this.props.disabledHoverStyle);
        }
      } else {
        if (this.state.isFocus && this.preventFocusStyleForTouchAndClick) {
          wrapperStyle = Object.assign({}, wrapperStyle, _rating2.default.focusStyle, this.props.focusStyle);
        }

        if (this.state.isHover) {
          wrapperStyle = Object.assign({}, wrapperStyle, _rating2.default.hoverStyle, this.props.hoverStyle);
        }
      }
