...
/**
 * @description Belle's toggle component
 * 
...
function updatePseudoClassStyle(styleId, properties, preventFocusStyleForTouchAndClick) {
  ...
  if (preventFocusStyleForTouchAndClick) {
    ...
    focusStyle = Object.assign({}, _toggle2.default.focusStyle, properties.focusStyle);
  }
...
var Toggle = function (_Component) {
  ...
  _createClass(Toggle, [{
    ...
    value: function render() {
      var wrapperStyle = Object.assign({}, _toggle2.default.style, this.props.style);

      if (this.isFocused && !this.state.wasFocusedWithClickOrTouch) {
        wrapperStyle = Object.assign({}, wrapperStyle, _toggle2.default.focusStyle, this.props.focusStyle);
      }

      var computedSliderStyle = void 0;
      var handleStyle = void 0;

      var sliderWrapperStyle = Object.assign({}, _toggle2.default.sliderWrapperStyle, this.props.sliderWrapperStyle);
      var defaultSliderOffset = this._getSliderOffset();

      if (this.state.isDraggingWithMouse || this.state.isDraggingWithTouch) {
        computedSliderStyle = Object.assign({}, _toggle2.default.sliderStyle, this.props.sliderStyle, {
        ...
        var activeStyle = Object.assign({}, _toggle2.default.activeHandleStyle, this.props.handleStyle);
        handleStyle = Object.assign({}, _toggle2.default.handleStyle, activeStyle, this.props.activeHandleStyle, {
          left: this.state.sliderOffset,
          transition: activeStyle.transition ? activeStyle.transition : 'none'
        });
      } else {
        handleStyle = Object.assign({}, _toggle2.default.handleStyle, this.props.handleStyle);
        computedSliderStyle = Object.assign({}, _toggle2.default.sliderStyle, {
          left: this.state.value ? 0 : -defaultSliderOffset
        });

        if (this.state.isActive) {
          handleStyle = Object.assign({}, handleStyle, _toggle2.default.activeHandleStyle, this.props.activeHandleStyle);
        } else if (this.state.isHovered) {
          handleStyle = Object.assign({}, handleStyle, _toggle2.default.hoverHandleStyle, this.props.hoverHandleStyle);
        }

        var position = {
          left: this.state.value ? defaultSliderOffset : 0
        };
        handleStyle = Object.assign({}, handleStyle, position);
      }
      ...
      var computedTrueChoiceStyle = Object.assign({}, _toggle2.default.firstChoiceStyle, this.props.firstChoiceStyle);
      var computedFalseChoiceStyle = Object.assign({}, _toggle2.default.secondChoiceStyle, this.props.secondChoiceStyle);
      ...
      if (this.props.disabled) {
        tabIndex = -1;
        wrapperStyle = Object.assign({}, wrapperStyle, _toggle2.default.disabledStyle, this.props.disabledStyle);
        handleStyle = Object.assign({}, handleStyle, _toggle2.default.disabledHandleStyle, this.props.disabledHandleStyle);
      }
