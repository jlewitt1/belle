...
/**
 * @description In the Rating component the focus style is not applied in case the component is focused on by a touch or click event. This default behaviour can be deactivated by setting `preventFocusStyleForTouchAndClick` to false
 * 
 * 
